...
func createRandomTransfer(t *testing.T, fromAccount, toAccount Account) Transfer {
	...
	require.True(t, transfer.CreatedAt.Valid) // Check if CreatedAt is not NULL
...
func TestListTransfersFrom(t *testing.T) {
	...
	// Create 10 transfers from the same account
	for i := 0; i < 10; i++ {
		createRandomTransfer(t, fromAccount, toAccount)
	}
	...
	transfers, err := testQueries.ListTransfersFrom(context.Background(), arg)
...
func TestListTransfersTo(t *testing.T) {
	...
	// Create 10 transfers to the same account
	for i := 0; i < 10; i++ {
		createRandomTransfer(t, fromAccount, toAccount)
	}
	...
	transfers, err := testQueries.ListTransfersTo(context.Background(), arg)
